...
def main():
  ...
  ninja = os.path.join('third_party', 'ninja', 'ninja.exe' if host == 'windows' else 'ninja')
  ...
  if host == 'linux' and host_machine == 'arm64':
    ninja = os.path.join('tools', 'skia_release', 'ninja-linux-arm64')
